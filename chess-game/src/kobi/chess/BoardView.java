...
public class BoardView extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int boardsize = measureHeight < measureHeight ?  measureHeight : measureWidth; 
		m_Board = Bitmap.createScaledBitmap(m_Board, boardsize, boardsize, false);
	}
	...
	private int getMeasurement(int measureSpec, int preferred)
	{
		...
		//m_Board = Bitmap.createScaledBitmap(m_Board, measurement, measurement, false);
		return measurement;
